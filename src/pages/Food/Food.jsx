    ...
    const [meals, setMeals] = React.useState([
        {
            id: 'breakfast',
            name: "Сніданок",
            icon: <BreakfastDiningIcon sx={{fontSize: '2.5rem', color: '#FFD700'}}/>,
            items: [],
            totalCalories: 0,
            time: "08:00"
        },
        {
            id: 'lunch',
            name: "Обід",
            icon: <LunchDiningIcon sx={{fontSize: '2.5rem', color: '#FFA07A'}}/>,
            items: [],
            totalCalories: 0,
            time: "13:30"
        },
        {
            id: 'dinner',
            name: "Вечеря",
            icon: <DinnerDiningIcon sx={{fontSize: '2.5rem', color: '#ADD8E6'}}/>,
            items: [],
            totalCalories: 0,
            time: "19:00"
        },
        {
            id: 'snacks',
            name: "Перекус",
            icon: <BakeryDiningIcon sx={{fontSize: '2.5rem', color: '#98FB98'}}/>,
            items: [],
            totalCalories: 0,
            time: "Між прийомами"
        },
        ...
        <AppTheme {...props}>
            ...
            <Box sx={{display: 'flex', flexDirection: 'column', minHeight: '100vh', position: 'relative'}}>
                ...
                <Box sx={{
                    ...
                    position: 'relative',
                    zIndex: 5,
                    backgroundColor: 'rgba(18, 9, 29, 0.8)'
                }}>
                    <Container maxWidth="xl">
                        <Typography variant="h3" component="h1" gutterBottom sx={{
                            ...
                            textAlign: 'center',
                            mb: {xs: 4, md: 6},
                            textShadow: '0 0 15px rgba(198, 126, 255, 0.5)',
                            animation: `${textFadeInUp} 1s ease-out 0.2s backwards`
                        }}>
                            Мій Раціон <RestaurantIcon sx={{
                            verticalAlign: 'middle',
                            fontSize: 'inherit',
                            color: '#c67eff',
                            filter: 'drop-shadow(0 0 8px rgba(198, 126, 255, 0.7))'
                        }}/>
                        </Typography>

                        <Box id="daily-summary-section" sx={{mb: {xs: 4, md: 6}}}>
                            <StaticCard sx={{
                                background: 'rgba(45, 38, 65, 0.9)',
                                p: {xs: 2, sm: 3},
                                '&::before': {background: 'linear-gradient(90deg, #66bb6a, #a96cff, #42a5f5)'}
                            }}>
                                <CardContent>
                                    <Typography variant="h5" component="h2"
                                                sx={{fontWeight: 'bold', color: 'white', mb: 3, textAlign: 'center'}}>Сьогоднішній
                                        Прогрес</Typography>
                                        ...
                                        {[
                                            {
                                                label: 'Калорії',
                                                key: 'calories',
                                                icon: <LocalFireDepartmentIcon sx={{mr: 0.5, color: '#ff7043'}}/>,
                                                consumed: dailyConsumed.calories,
                                                goal: dailyGoals.calories,
                                                unit: 'ккал',
                                                color: '#ff7043',
                                                gradient: 'linear-gradient(90deg, #ff7043, #f4511e)'
                                            },
                                            {
                                                label: 'Білки',
                                                key: 'protein',
                                                icon: <EggIcon sx={{mr: 0.5, color: '#66bb6a'}}/>,
                                                consumed: dailyConsumed.protein,
                                                goal: dailyGoals.protein,
                                                unit: 'г',
                                                color: '#66bb6a',
                                                gradient: 'linear-gradient(90deg, #66bb6a, #388e3c)'
                                            },
                                            {
                                                label: 'Жири',
                                                key: 'fat',
                                                icon: <OilBarrelIcon sx={{mr: 0.5, color: '#ffc107'}}/>,
                                                consumed: dailyConsumed.fat,
                                                goal: dailyGoals.fat,
                                                unit: 'г',
                                                color: '#ffc107',
                                                gradient: 'linear-gradient(90deg, #ffc107, #ffa000)'
                                            },
                                            {
                                                label: 'Вуглеводи',
                                                key: 'carbs',
                                                icon: <GrainIcon sx={{mr: 0.5, color: '#42a5f5'}}/>,
                                                consumed: dailyConsumed.carbs,
                                                goal: dailyGoals.carbs,
                                                unit: 'г',
                                                color: '#42a5f5',
                                                gradient: 'linear-gradient(90deg, #42a5f5, #1e88e5)'
                                            },
                                        ].map(nutrient => {
                                            const progressValue = nutrient.goal > 0 ? (nutrient.consumed / nutrient.goal) * 100 : 0;
                                            return (
                                                <Grid item xs={12} sm={6} md={3} key={nutrient.key}
                                                      sx={{textAlign: 'center'}}>
                                                    ...
                                                    }}>{nutrient.icon}{nutrient.label}</Typography>
                                                    <Typography variant="h4" sx={{
                                                        color: nutrient.color,
                                                        fontWeight: 'bold'
                                                    }}>{nutrient.consumed} / {nutrient.goal} <Box component="span" sx={{
                                                        fontSize: '1rem',
                                                        color: 'rgba(230, 220, 255, 0.7)'
                                                    }}>{nutrient.unit}</Box></Typography>
                                                    <StyledLinearProgress variant="determinate"
                                                                          value={Math.min(progressValue, 100)}
                                                                          sx={{[`& .${linearProgressClasses.bar}`]: {background: nutrient.gradient}}}/>
                                                </Grid>
                                            );
                                        })}
                                    </Grid>
                        ...
                        <Typography variant="h4" component="h2" sx={{
                            ...
                            fontWeight: 'bold',
                            color: 'white',
                            textShadow: '0 0 10px rgba(198, 126, 255, 0.3)'
                        }}>Прийоми їжі сьогодні</Typography>
                            ...
                            {meals.map((meal) => (
                                <Grid item xs={12} sm={6} md={3} key={meal.id}>
                                    <StaticCard sx={{
                                        ...
                                        '&::before': {background: `linear-gradient(90deg, ${meal.icon.props.sx.color}99, ${meal.icon.props.sx.color}FF)`}
                                    }}>
                                        <CardContent sx={{
                                            p: {xs: 2, sm: 2.5},
                                            flexGrow: 1,
                                            ...
                                            <Box sx={{
                                                ...
                                                alignItems: 'center',
                                                mb: 2,
                                                color: meal.icon.props.sx.color
                                            }}>
                                                {meal.icon}
                                            ...
                                            <Box sx={{mb: 1.5}}>
                                                <Typography variant="caption"
                                                            sx={{color: 'rgba(230, 220, 255, 0.6)'}}>Час: {meal.time}</Typography>
                                            </Box>
                                            <Box sx={{
                                                flexGrow: 1,
                                                mb: 2,
                                                ...
                                                {meal.items.length > 0 ? meal.items.map((item) => (
                                                    <Box key={item.id} sx={{
                                                        ...
                                                        <Typography variant="caption" sx={{
                                                            ...
                                                            Б:{item.protein} Ж:{item.fats} В:{item.carbs}</Typography>
                                                    </Box>
                                                )) : (
                                                    <Box sx={{
                                                        display: 'flex',
                                            ...
                                            <Typography variant="subtitle1" sx={{
                                                ...
                                                mt: 'auto',
                                                textAlign: 'right'
                                            }}>{meal.totalCalories} ккал</Typography>
                                        </CardContent>
                                    </StaticCard>
                                </Grid>
                            ))}
                        ...
                        <Paper elevation={12} sx={{
                            ...
                            <Box sx={{
                                ...
                                <ManageSearchIcon sx={{
                                    ...
                                    fontSize: '2.8rem',
                                    color: '#b388ff',
                                    filter: 'drop-shadow(0 0 10px #b388ff77)'
                                }}/>
                                <Typography variant="h5" component="h2"
                                            sx={{fontWeight: '600', textShadow: '0 0 10px rgba(180,130,255,0.4)'}}>
                                    Знайти Страви
                                </Typography>
                            </Box>
                            <Grid container spacing={2} sx={{mb: 3, alignItems: 'stretch', flexShrink: 0}}>
                                <Grid item xs={12} lg={3.5}>
                                    <FilterTextField fullWidth label="Назва страви" variant="outlined"
                                ...
                                {[
                                    ...
                                    <Grid item xs={6} sm={3} lg={1.875} key={`${filter.name}-select-filter`}>
                                        <FilterSelectControl fullWidth variant="outlined">
                                            ...
                                            <Select labelId={`${filter.name}-label`} name={filter.name}
                                                    value={filters[filter.name]} onChange={handleFilterChange}
                                                    label={filter.label}
                                                    startAdornment={filter.icon ? <InputAdornment
                                                        position="start">{React.cloneElement(filter.icon, {fontSize: 'small'})}</InputAdornment> : null}
                                                    MenuProps={{
                                                        PaperProps: {
                                                            sx: {
                                                                maxHeight: 250,
                                                                backgroundColor: 'rgba(45, 38, 65, 0.98)',
                                                ...
                                                {filter.options.map(opt => <MenuItem
                                                    key={`${filter.name}-option-${opt}`} value={opt}>{opt}</MenuItem>)}
                                            </Select>
                                        </FilterSelectControl>
                                    </Grid>
                                ))}
                                <Grid item xs={12} sm={12} lg={1.5} sx={{display: 'flex', alignItems: 'stretch'}}>
                                    <FilterActionButton fullWidth startIcon={<SearchIcon/>} onClick={handleSearch}
                                                        disabled={isLoadingSearch}>{isLoadingSearch ? '...' : 'Знайти'}</FilterActionButton>
                                </Grid>
                            </Grid>
                                ...
                                <Grid container spacing={{xs: 2, sm: 2.5}}>
                                    {isLoadingSearch ? (
                                        <Grid item xs={12} sx={{textAlign: 'center', py: 5}}>
                                            <Typography sx={{color: '#c67eff', fontStyle: 'italic'}}>Завантаження
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <Box
                                                            ...
                                                            {food.type &&
                                                                <Chip icon={<RestaurantIcon fontSize="small"/>}
                                                                      label={food.type} size="small" sx={{
                                                                    bgcolor: 'rgba(255,255,255,0.1)',
                                                                    color: 'rgba(230,220,255,0.8)'
                                                                }}/>}
                                                            {food.goal &&
                                                                <Chip icon={<FitnessCenterIcon fontSize="small"/>}
                                                                      label={food.goal} size="small" sx={{
                                                                    bgcolor: 'rgba(255,255,255,0.1)',
                                                                    color: 'rgba(230,220,255,0.8)'
                                                                }}/>}
                                                            {food.diet && <Chip icon={<SpaIcon fontSize="small"/>}
                                                                                label={food.diet} size="small" sx={{
                                                                bgcolor: 'rgba(255,255,255,0.1)',
                                                                color: 'rgba(230,220,255,0.8)'
                                                            }}/>}
                                                            {food.difficulty &&
                                                                <Chip icon={<SpeedIcon fontSize="small"/>}
                                                                      label={food.difficulty} size="small" sx={{
                                                                    bgcolor: 'rgba(255,255,255,0.1)',
                                                                    color: 'rgba(230,220,255,0.8)'
                                                                }}/>}
                                                            {food.prepTime &&
                                                                <Chip icon={<ScheduleIcon fontSize="small"/>}
                                                                      label={`${food.prepTime} хв`} size="small" sx={{
                                                                    bgcolor: 'rgba(255,255,255,0.1)',
                                                                    color: 'rgba(230,220,255,0.8)'
                                                                }}/>}
                                                        ...
                                                        <Grid container spacing={0.5} sx={{
                                                            ...
                                                            <Grid item xs={6}
                                                                ...
                                                                <BarChartIcon fontSize="inherit" sx={{
                                                                    mr: 0.5,
                                                                    color: '#c67eff'
                                                            ...
                                                            <Grid item xs={6}
                                                                  sx={{display: 'flex', alignItems: 'center'}}>
                                                                <OilBarrelIcon fontSize="inherit" sx={{
                                                                    mr: 0.5,
                                                                    color: '#c67eff'
                                                                }}/> Ж: {food.fats || 0}г
                                                            </Grid>
